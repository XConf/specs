...
const resolvers = {
  ...
  ScheduleItem: {
    id: globalIdResolver(),
    timePeriods: (obj) => getData(confData)('timePeriods').filter(o => obj.timePeriodIds.includes(o.id)),
    locations: (obj) => getData(confData)('locations').filter(o => obj.locationIds.includes(o.id)),
    event: (obj) => {
      if (obj.event) {
        return obj.event
